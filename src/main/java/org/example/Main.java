...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        //CREATE
        createRecord(getRandomStr(5), getRandomStr(10),getRandomStr(5),getRandomStr(8),getRandomDate());
    ...
    private static void createRecord(String login, String pswrd, String name, String surname, String date){
